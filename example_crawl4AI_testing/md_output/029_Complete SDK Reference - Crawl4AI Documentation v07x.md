# 📚 Complete SDK Reference - Crawl4AI Documentation (v0.7.x)

- **URL:** https://docs.crawl4ai.com/complete-sdk-reference
- **Depth:** 1
- **Hash:** ef7013ab2d68fee8050af48d4db03871
...
* * *
  ...
  * [1. BrowserConfig – Controlling the Browser](https://docs.crawl4ai.com/complete-sdk-reference/#1-browserconfig-controlling-the-browser)
  ...
  * [1. How “Fit Markdown” Works](https://docs.crawl4ai.com/complete-sdk-reference/#1-how-fit-markdown-works)
  ...
  * [4. Accessing the “Fit” Output](https://docs.crawl4ai.com/complete-sdk-reference/#4-accessing-the-fit-output)
  * [5. Code Patterns Recap](https://docs.crawl4ai.com/complete-sdk-reference/#5-code-patterns-recap)
  * [6. Combining with “word_count_threshold” & Exclusions](https://docs.crawl4ai.com/complete-sdk-reference/#6-combining-with-word_count_threshold-exclusions)
...
#  `arun_many(...)` Reference
> **Note** : This function is very similar to [`arun()`](https://docs.crawl4ai.com/complete-sdk-reference/arun.md) but focused on **concurrent** or **batch** crawling. If you’re unfamiliar with `arun()` usage, please read that doc first, then review this for differences.
## Function Signature
```
async def arun_many(
...
### Return Value
Either a **list** of [`CrawlResult`](https://docs.crawl4ai.com/complete-sdk-reference/crawl-result.md) objects, or an **async generator** if streaming is enabled. You can iterate to check `result.success` or read each item’s `extracted_content`, `markdown`, or `dispatch_result`.
...
eg:`api_token = "env: GROQ_API_KEY"`
  ...
  8. `backoff_base_delay` _(default`2` seconds)_ – how long to pause before the first retry if the provider rate-limits you. 
  9. `backoff_max_attempts` _(default`3`)_ – total tries for the same prompt (initial call + retries). 
  10. `backoff_exponential_factor` _(default`2`)_ – how quickly the pause grows between retries. A factor of 2 yields waits like 2s → 4s → 8s. 
  11. Because these plug into Crawl4AI’s retry helper, every LLM strategy automatically follows the pacing you define here. 
```
...
8. **`before_return_html`**– Right before returning the HTML content.**Important** : Avoid heavy tasks in `on_browser_created` since you don’t yet have a page context. If you need to _log in_ , do so in **`on_page_context_created`**.
...
#### On this page
  ...
  * [What’s Happening?](https://docs.crawl4ai.com/complete-sdk-reference/#whats-happening)
  ...
  * [3. Handling Dynamic Content](https://docs.crawl4ai.com/complete-sdk-reference/#3-handling-dynamic-content)
  * [3.1 Load More Example (Hacker News “More” Link)](https://docs.crawl4ai.com/complete-sdk-reference/#31-load-more-example-hacker-news-more-link)
